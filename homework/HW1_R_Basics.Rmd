...
I think I'm having some trouble properly loading the tidyverse library for step 1.4. It seems like that step worked correctly, but error tags are showing up for the task after ("Load some CSV data"), which I think is stemming from problems with the tidyverse in step 1.4. I could be totally wrong, but I'm just not sure what the error is here and what the tag is telling me.
