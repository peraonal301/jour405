...
I would say this graph is slightly skewed to the left, as there are a few outliers and most of the data is clustered toward the higher count (or tale-end) of the graph. This graph shows that around eight to 16 people fall within the one standard deviation, or 68%, of the mean.
